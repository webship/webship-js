module.exports = {
  /**
   * Fill the Input Box With the Value
   * 
   * Function to find input by 
   * id|class|name|placeholder|label 
   * and fill it with sent value
  */
  fillInputWithValue: function (field, value) {
    let element = null;
    let selector = field;
